<?php $exposed_mt_cls = '';
    ...
    <?php $exposed_gallery_items = get_post_meta( get_the_ID(), '_exposed_post_galery_list', 1 ); ?>
    <?php if(!empty($exposed_gallery_items)): ?>
	    <br><br>
		<ul class="bxslider">
		  <?php foreach ( (array) $exposed_gallery_items as $attachment_id => $attachment_url ) { ?> 
		  <li><img src="<?php echo esc_url($attachment_url); ?>" alt="<?php esc_attr_e('exposed gallery','exposed'); ?>"/></li>  
		  <?php } ?>
		</ul>
	<?php endif; ?> 
    <p>
