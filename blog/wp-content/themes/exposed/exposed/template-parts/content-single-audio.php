<?php $exposed_mt_cls = '';
    ...
    <?php $exposed_audio = get_post_meta(get_the_ID(),'_exposed_post_audio',true); ?>
    <?php if($exposed_audio!=''): ?>
	    <br> <br> 
	    <div class="scloud">
			<iframe width="700" height="360" src="<?php echo esc_url($exposed_audio); ?>"></iframe> 
	    </div> 
	<?php endif; ?>
    <br> 
    <br> 
